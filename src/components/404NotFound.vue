<template>
  <!-- <div class="not-found">
      <img src="@/assets/images/404NotFound.png" alt="404 Not Found" style="max-width: 100%; height: auto;" />
  ...
  <section class="d-flex align-items-lg-center align-items-end position-relative min-vh-100 py-lg-5 py-0">
    <!-- Bg overlay--><span
      class="position-absolute top-0 start-0 d-lg-block d-none w-100 h-100 zindex-1 bg-dark rounded-4 rounded-start-0"
      style="max-width: 43.6vw;"></span>
    <!-- Overlay content-->
