<template>
    <div class="guide-page">
      ...
      <div class="pagination">
        <a href="#" class="older-posts" @click.prevent="prevPage" :disabled="currentPage === 1">Older posts</a>
        <a href="#" class="newer-posts" @click.prevent="nextPage" :disabled="currentPage === totalPages">Newer posts</a>
      </div>
    </div>
  </template>
  ...
  .older-posts:disabled,
  .newer-posts:disabled {
    color: #ccc;
    cursor: not-allowed;
  }
  
  .older-posts:hover:not([disabled]),
  .newer-posts:hover:not([disabled]) {
